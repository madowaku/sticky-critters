...
- **Tray Icon Drop**: Dropping files or folders directly onto the system tray icon is not supported in v0.1 beta. Use the tray menu's **Kangaroo Pocket**, which opens a small lower-right drop window instead.
...
- **Kangaroo Pocket**: The pocket accepts files, folders, and images in the Tauri desktop app. After a successful drop, the main window is shown and Click-through is reset to Edit Mode.
